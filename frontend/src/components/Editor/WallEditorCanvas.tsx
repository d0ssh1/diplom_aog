...
function WallEditorCanvasImpl(props: WallEditorCanvasProps, ref: React.ForwardedRef<WallEditorCanvasRef>) {
  const {
    maskUrl,
    activeTool,
    brushSize,
...
const WallEditorCanvas = forwardRef(WallEditorCanvasImpl);
